...
export default function Hero() {
  return (
    <section id="top" className="relative min-h-screen flex items-center pt-32 pb-20 overflow-hidden bg-background">
      {/* Decorative Grid Pattern */}
      <div className="absolute inset-0 grid-pattern opacity-60 pointer-events-none" aria-hidden="true" />
      
      {/* Glowing Purple Blurs */}
      <div className="absolute -top-40 -right-40 w-[600px] h-[600px] bg-primary/10 rounded-full blur-[120px] pointer-events-none" aria-hidden="true" />
      <div className="absolute -bottom-40 -left-40 w-[600px] h-[600px] bg-primary/5 rounded-full blur-[120px] pointer-events-none" aria-hidden="true" />
      ...
      <div className="container mx-auto max-w-7xl px-6 relative z-10 grid lg:grid-cols-12 gap-12 lg:gap-8 items-center w-full">
        ...
        <div className="lg:col-span-7 flex flex-col text-left">
          ...
          >
            ...
            <span>Crafting digital experiences since day one</span>
          </motion.div>
          ...
          >
Webbiko is a web development studio designing static, dynamic and fully custom websites built to engage visitors, generate leads and grow your brand.          </motion.p>
          ...
          >
            {[
              ...
              <div key={stat.l} className="flex flex-col">
                <span className="font-display text-3xl lg:text-4xl font-black text-foreground">{stat.n}</span>
                <span className="text-xs sm:text-sm text-muted-foreground mt-1">{stat.l}</span>
              </div>
            ))}
          </motion.div>
        </div>
        ...
        >
          ...
          <div className="relative w-full h-full rounded-[32px] overflow-hidden shadow-elegant border border-border/40 bg-surface flex items-center justify-center">
            ...
            <div className="relative w-72 h-72 rounded-full border border-primary/20 flex items-center justify-center animate-pulse">
              ...
              <div className="relative w-28 h-28 rounded-full border-2 border-primary bg-background flex flex-col items-center justify-center p-4 shadow-glow">
                <span className="font-display font-black text-xl text-primary">Webbiko</span>
                <span className="text-[10px] text-muted-foreground uppercase tracking-widest mt-1">Studio</span>
              </div>
            </div>
          ...
          >
            <div className="text-[10px] opacity-70 uppercase tracking-widest">SEO Score</div>
            <div className="font-display text-xl sm:text-2xl font-black mt-1">A+</div>
          </motion.div>
        </motion.div>
      </div>
    </section>
