      ...
      <div className="container mx-auto max-w-7xl px-6">
        ...
        <div className="grid md:grid-cols-12 gap-10 mb-12">
          ...
          <div className="md:col-span-5 flex flex-col gap-4">
            <a href="#top" className="flex items-center gap-2 font-display font-black text-2xl tracking-tight text-foreground select-none">
              Webbiko<span className="text-primary font-bold">.</span>
            </a>
            <p className="text-muted-foreground text-sm leading-relaxed max-w-xs">
              A web development studio building static, dynamic and custom websites that perform.
            </p>
          </div>
            ...
            <ul className="space-y-3.5 text-sm">
              ...
              <li>
                ...
                >
                  ...
                  <span>muhammedshifinpkd@gmail.com</span>
                </a>
              </li>
            </ul>
          </div>
        ...
        <div className="pt-8 border-t border-border flex flex-col sm:flex-row items-center justify-between gap-4 text-xs sm:text-sm text-muted-foreground">
          <p className="cursor-default">
            &copy; {new Date().getFullYear()} Webbiko<span className="text-primary font-bold">.</span> All rights reserved.
          </p>
          <p className="cursor-default">
            Crafted with care &middot; Web development studio
          </p>
        </div>
      </div>
    </footer>
