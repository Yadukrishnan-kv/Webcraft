...
export default function Founder() {
  return (
    <section id="founder" className="relative py-24 lg:py-40 bg-background overflow-hidden">
      {/* Visual background grids */}
      <div className="absolute inset-0 grid-pattern opacity-40 pointer-events-none" aria-hidden="true" />
      <div className="absolute -top-40 left-1/2 -translate-x-1/2 w-[700px] h-[700px] bg-primary/10 rounded-full blur-3xl pointer-events-none" aria-hidden="true" />
        ...
        <div className="grid lg:grid-cols-12 gap-12 lg:gap-20 items-center">
          ...
          >
            ...
            <div className="relative w-full h-full rounded-[32px] bg-foreground text-background overflow-hidden shadow-elegant border border-border/40">
              ...
              {/* Internal neon blurs */}
              <div className="absolute -top-20 -right-20 w-64 h-64 bg-primary/40 rounded-full blur-3xl animate-blob pointer-events-none" aria-hidden="true" />
              <div className="absolute -bottom-24 -left-24 w-72 h-72 bg-primary/20 rounded-full blur-3xl animate-blob pointer-events-none" style={{ animationDelay: "2s" }} aria-hidden="true" />
              ...
              <div className="absolute inset-0 flex items-center justify-center pointer-events-none select-none">
                <span className="font-display font-black text-[10rem] sm:text-[11rem] leading-none tracking-tighter text-background">
                  MS<span className="text-primary font-bold">.</span>
                </span>
              </div>
          ...
          <div className="lg:col-span-7 text-left">
            ...
            >
              Muhammed <span className="gradient-text">Shifin N.</span>
            </motion.h2>
            ...
            >
              <p>
                Hi — I'm Shifin, a 17-year-old self-taught developer from Kerala, India, and the founder of{" "}
                <span className="text-foreground font-semibold">Webbiko</span>. I started building websites because I believed brands deserved more than slow, cookie-cutter templates.
              </p>
              <p>
                Today I help founders and businesses ship{" "}
                <span className="text-foreground font-semibold">static, dynamic and fully custom websites</span> that are blazing fast, beautifully designed and deeply SEO-optimised — built with care, shipped with pride.
              </p>
            </motion.div>
            ...
            >
              {[
                { icon: CodeXml, label: "Builds", value: "Static · Dynamic · Custom" },
                { icon: Globe, label: "Working", value: "Worldwide" },
                { icon: Compass, label: "Philosophy", value: "Clean & Custom" }
              ].map((highlight) => (
                <div key={highlight.label} className="rounded-2xl border border-border bg-surface p-4 hover:border-primary/50 transition-colors duration-300 group cursor-default">
